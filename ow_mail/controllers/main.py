...
class OwMailController(http.Controller):
    ...
    @http.route("/ow_mail/bootstrap", type="jsonrpc", auth="ow_mail_user")
    def bootstrap(self):
    ...
    @http.route("/ow_mail/prefs/save", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/sync", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/messages", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/calendar/from_invite", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/record/prefill", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/record/attach", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/record/models", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/message", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/thread", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/attachment/prepare", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/send", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/draft", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/draft/discard", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/message/action", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/folder/create", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/folder/rename", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/folder/move", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/folder/delete", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/folder/subscribe", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/account/quota", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/folder/empty", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/contacts/list", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/contacts/suggest", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/contacts/create", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/contacts/update", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/contacts/delete", type="jsonrpc", auth="ow_mail_user")
    ...
    @http.route("/ow_mail/contacts/touch", type="jsonrpc", auth="ow_mail_user")
